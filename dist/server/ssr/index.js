...
var client_references_default = {
	...
	"6306e2d9f6f0": async () => {
		const m = await import("./assets/BackToTop-LWY3cj0_.js");
		return { get "BackToTop"() {
			return m["BackToTop"];
		} };
	},
	"c7fa5cfea253": async () => {
		const m = await import("./assets/error-boundary-C6w_1nMi.js");
		return {
			get "ErrorBoundary"() {
	...
	"da06f1d026a2": async () => {
		const m = await import("./assets/layout-segment-context-kWoylGNg.js");
